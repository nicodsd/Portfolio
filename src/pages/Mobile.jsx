...
function Mobile() {
  return (
    <div className='md:min-h-screen overflow-hidden relative selection:bg-transparent py-32 flex w-full justify-between gap-x-3 items-center text-mono'>
      ...
      <motion.div className="z-30 md:h-[17vw]" initial={{ opacity: 0, x: 100 }} whileInView={{ opacity: 1, x: 0 }} transition={{ duration: 0.2, type: "spring", stiffness: 200 }}>
        <svg xmlns="http://www.w3.org/2000/svg" className="hidden md:block h-auto md:w-[200px]" fill="none" viewBox="0 0 268 305"><path id="forma" fill="#ff0080" d="M167.351.715c55.229 0 100 44.771 100 100v118.731H100.917c-55.229 0-100-44.772-100-100v-18.731c0-55.229 44.771-100 100-100z" /><path id="forma" fill="#000" d="M267.351 219.446v84.882H.917c0-46.879 38.003-84.882 84.882-84.882z" /></svg>
      </motion.div>
    </div>
  )
}
