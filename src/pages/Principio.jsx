        ...
        <>
            <div className='mt-4 mx-10 md:px-10 md:mx-[10vh] selection:bg-transparent md:cuerpo text-mono md:mt-20 z-20'>
                ...
                <div className='flex flex-col items-center md:flex-row md:items-end justify-between'>
                    ...
                    <svg xmlns="http://www.w3.org/2000/svg" className="z-10 w-[60vw] md:w-[35vw] animate__animated animate__backInRight" viewBox="0 0 743.92 350.37"><g id="Capa_2" data-name="Capa 2"><g id="por_encima" data-name="por encima"><path d="M532.27 283.55a68.8 68.8 0 0 1-25.48 11.39c-40.64 7.53-72.59-3.7-90-49.32-18.47-48.33-2.23-85 40.81-89.2 17.71-1.71 33.9.91 47.93 8.27a143 143 0 0 1 15-46.43c-24-12.19-51.63-16.52-81.71-13.58-74.6 7.31-106.43 85.14-74.39 169 30.21 79.1 89.23 84.26 159.7 71.2 13.1-2.44 37-11.35 55.41-29q-28.69-10-47.27-32.33" className="cls-1" /><path d="M720.15 107q-26.76-33.27-78.68-36.48Q592.1 67.47 560 98.36t-35.37 83q-3.33 53.84 23.48 88.06t78.73 37.45q50.85 3.15 82.1-27.16t34.6-84.71q3.39-54.72-23.39-88m-31.93 84.52q-2.24 36.16-18 54.84t-40.71 17.14q-54.25-3.36-49.58-78.68 2.18-35.12 18.07-53.77t40.78-17.12q54.05 3.35 49.44 77.6ZM249.54 73.86l18.22 118.63L116.28 0H46.82l94.75 125.69c-61.8 16.47-96 47.32-120.06 95.94C0 265 0 318.88 0 318.88h69.45c.19-74.19 46.48-133.41 110.05-142.88l3.9 5.17 103.78 137.7h63.06l-37.64-245Z" className="cls-1" /><circle cx="349.52" cy="36.99" r="36.86" className="cls-1" /></g></g></svg>
                </div>
