    ...
    return (
        <>
            <div className='mt-24 md:h-fit px-5 selection:bg-transparent md:cuerpo text-mono md:mt-10 z-20 overflow-x-hidden'>
                <img className='animate__fadeIn animate__animated absolute h-[17vw] md:h-[14vw] md:top-38 left-[12%] sm:left-[10%] md:left-[37%] lg:left-[38%] drop-shadow-xl z-20 asterixco' src={asterixco} alt="asterixco" />
                <div className='flex flex-col items-center md:flex-row md:items-end justify-between'>
                    <div className='flex md:-indent-2 flex-col font-[700] z-40 animate__fadeInLeft animate__animated'>
                        <p className='nicoBarrera nico text-[10vw] h-[8vw] md:h-[7.6vw]'> Nico </p>
                        <p className='nicoBarrera text-[10vw] h-[14vw] md:h-[12vw]'> Barrera </p>
                    </div>
