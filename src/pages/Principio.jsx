...
function Principio() {
    return (
        <>
            <div className='mt-4 md:px-[13vw] selection:bg-transparent md:cuerpo text-mono md:mt-20 z-20'>
