...
function Principio() {
    return (
        <>
            <div className='h-screen mt-24 md:h-fit px-5 md:cuerpo text-mono md:mt-10 z-20 overflow-x-hidden'>
                <img className='animate__fadeIn animate__animated absolute h-12 md:h-[11rem] text-[#FFD400] md:top-38 left-12 md:left-[41%] drop-shadow-xl z-20 asterixco' src={asterixco} alt="asterixco" />
