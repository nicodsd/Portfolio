    ...
    return (
        <div id='sobreMi' className='min-h-screen selection:bg-transparent pt-16 md:py-14 flex flex-col md:flex-row justify-between items-center gap-y-14 md:gap-y-0'>
            <div className='md:w-[60%] lg:w-[60%] h-full text-mono text-black flex flex-col justify-center px-5 lg:px-14 z-10'>
                ...
                <p className='text-sm leading-5 text-black font-[300]'>Soy Nicolas Barrera, me identifico como una persona multifacética e inquieta.
                ...
                <p className='text-sm leading-5 text-black font-[300]'>Estudié dos carreras las cuales estaban fuera del rango del arte, hoy por hoy
                ...
                <p className='text-sm leading-5 text-black font-[300]'>Al inicio solo deseaba expresar mis emociones por medio de ilustraciones
                ...
                <p className='text-sm leading-5 py-2 text-black font-[300]'>Teniendo en cuenta esto como referencia para crear mi marca y generar una imagen de dinamismo, en
