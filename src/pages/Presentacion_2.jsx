...
function Presentacion_2() {
    ...
    return (
        <div id='sobreMi' className='min-h-screen selection:bg-transparent py-20'>
            <div className='flex justify-between items-center gap-y-10 md:gap-y-0'>
                <div className='flex justify-between flex-col md:flex-row'>
                    <div className='md:w-[70%] relative text-mono flex flex-col justify-center z-10'>
                        <h2 id="titular" className="lg:text-[10rem] text-[7rem] lg:-top-[16rem] -top-[5rem] tracking-tighter font-[500]">Hola</h2>
