            ...
            <div className=' md:w-[16vw] overflow-y-auto bg-white absolute md:relative w-0 invisible md:visible z-0 md:z-20 p-2 md:pt-3 lg:pt-6 min-h-screen rounded-lg'>
                ...
                <div className='flex gap-y-3 flex-col'>
                    {informacion?.pagina === "homeessentials" ? (
                        <h2 onClick={() => { irSeccion('video') }} className=" hover:scale-[1.03] hover:translate-x-1 text-xs cursor-pointer"> <span style={{ color: informacion.color }}>#</span> Demostración en video</h2>
                    ) : (
