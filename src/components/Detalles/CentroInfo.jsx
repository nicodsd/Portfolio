...
function CentroInfo(props) {
    ...
    return (
        <>
            ...
            <div className='w-screen bg-white md:max-w-[60vw] min-h-screen md:h-screen md:overflow-auto gap-y-16 flex flex-col pt-12 md:pt-3 md:px-5 lg:px-8 xl:px-10 px-4 pb-10 z-20 md:pb-[10vh] rounded-lg'>
                <div>
                    <h1 style={{ color: color }} className="text-[3.1rem] leading-none md:-indent-2 -tracking-[5px] md:text-[3rem] lg:text-[7vw] xl:text-[5.6rem] font-[400] md:font-[300] lg:font-[100] mb-2 md:mb-4">{titulo}*</h1>
