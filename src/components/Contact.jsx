        ...
        <div className='flex justify-center w-full'>
          <form className='flex flex-col w-full text-sm gap-y-14' action="/post">
            <div className='w-full flex gap-x-4 text-mono'>
              <input className='w-[49%] border-b-[1px] bg-transparent border-[#000000] placeholder:text-[#0600ff]' type="text" placeholder='Nombre' />
              <input className='w-[49%] border-b-[1px] bg-transparent border-[#000000] placeholder:text-[#0600ff]' type="text" placeholder='Apellido' />
            </div>
            <div className='w-full flex gap-x-4 text-mono'>
              <input className='w-[49%] border-b-[1px] bg-transparent border-[#000000] placeholder:text-[#0600ff]' type="text" placeholder='Email' />
              <input className='w-[49%] border-b-[1px] bg-transparent border-[#000000] placeholder:text-[#0600ff]' type="text" placeholder='Teléfono' />
            </div>
            <div>
              <input className='w-full border-b-[1px] bg-transparent h-fit text-mono border-[#000000] placeholder:text-[#0600ff]' type="text" placeholder='Comentarios' />
            </div>
            <div className='flex w-full justify-center pt-12'>
              <div className='flex cursor-pointer'>
                <input className='bg-[#0600ff] w-24 cursor-pointer text-sm p-3  text-white text-mono' type="submit" value="Enviar" />
                <div className='border bg-[#e2e8ee] w-[2.7rem]  flex items-center justify-center'>
