...
function Footer() {
  return (
    <footer className='selection:bg-transparent w-full text-black text-mono p-10 md:px-30 md:py-30 z-0 relative flex justify-center'>
      <div className='flex flex-col'>
        ...
        <p className='text-xs mt-1 text-end'>© Nico Barrera {new Date().getFullYear()}.</p>
      </div>
    </footer>
  )
}
