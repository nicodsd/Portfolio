...
function Footer() {
  return (
    <footer className='bg-[#0600ff] h-[10.5rem] w-full text-white text-mono p-5 md:p-8 z-40 relative flex justify-between'>

      <div className='h-full md:w-[10%] flex flex-col justify-between'>
