...
function Footer() {
  return (
    <footer className='bg-[#0600ff] h-52 w-full text-white text-mono p-10 z-50 relative flex justify-between'>

      <div className='h-full w-[10%] flex flex-col justify-between'>
        <p className='text-[2.8vh] font-[700] border-b-4 border-white'>redes</p>
        <div>
          <Anchor>
            <p>Github</p>
          </Anchor>
      ...
      <div className='w-[30%] flex flex-col justify-between items-end'>
        <Anchor className='flex text-[2.8vh] font-[700] justify-between items-center'>
          <p className='mr-3'>Contacta conmigo</p>
          <img className='h-4' src={flech1} alt="" />
        </Anchor>
        <div className='flex flex-col w-full items-end'>
          ...
          <p className='w-52 text-end'>Nico Barrera 2023</p>
        </div>
      </div>
    </footer>
  )
