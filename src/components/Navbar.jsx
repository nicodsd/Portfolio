    ...
    <>
      ...
      <nav className="relative w-full text-mono z-10 p-2 md:p-0">
        <div className="w-full text-[#000000] flex justify-between lg:px-6 lg:py-[20px] items-center">
          <div onClick={() => sideBar()} className="w-8 visible md:invisible h-8 left-2 z-10 md:z-0 absolute lg:w-8 flex items-center justify-center lg:h-8 bg-[#000000] rounded-full animate__flash animate__animated animate__delay-1s animate__faster">
            <img className='w-5' src={burger} alt="" />
          </div>

          <div className='flex gap-x-8'>
            <div className="w-4 h-4 lg:w-8 lg:h-8 bg-[#000000] invisible md:visible rounded-full animate__flash animate__animated animate__delay-1s animate__faster"></div>
