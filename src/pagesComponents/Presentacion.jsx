function Presentacion() {
    return (
        <>
            <div className='h-auto px-20 selection:bg-transparent w-full flex justify-between text-[3.6vw] md:text-[1.6rem] lg:text-[2rem] items-center'>
