      ...
      <div className='h-screen relative w-full flex justify-center items-center'>
        ...
        <div className='text-mono text-xl flex items-center font-semibold text-[#0600ff] z-10'>
          ...
          <div className='flex items-center ml-6'>
            ...
            <a href='#' onClick={()=>contactoDiseño} className='border-[3px] border-[#0600ff] hover:bg-[#ffffff] duration-100 rounded-full px-7 text-[60px]'><HiArrowLongRight className='h-10'/></a>
          </div>
        </div>
      </div>
    </>
