...
const gridContainerVariants = {
    ...
    show: {
        opacity: 1,
        transition: {
            staggerChildren: 0.12, // Anima las tarjetas una tras otra automáticamente
        },
    },
}
...
export default function Proyectos() {
    ...
    return (
        <section className="pt-24 pb-5 px-4 md:px-10 bg-linear-to-b from-[#FFD400] via-white to-[#ffffff] selection:bg-transparent text-mono flex flex-col md:items-start w-full lg:pb-14">
            <div
                id="proyectos"
                className="h-full md:ml-6 border-x border-t md:mb-4 p-5 rounded-t-lg"
            >
                <motion.h2
            ...
            <div className="w-full flex justify-center items-center">
                <motion.div
                    className="grid grid-cols-1 sm:grid-cols-2 gap-4 w-full md:px-0"
                    initial="hidden"
                    whileInView="show"
